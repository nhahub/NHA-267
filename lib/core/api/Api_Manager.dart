...
class ApiManager {
  Dio dio = Dio();
    ...
    getData({required String endpoint , Map<String, dynamic>? queryParameters,Option? options
...
headers: headers
  ...
  postData({required String endpoint , Map<String, dynamic>? queryParameters,Option? options,Object? body
    ,Map<String, dynamic>? headers,}){
